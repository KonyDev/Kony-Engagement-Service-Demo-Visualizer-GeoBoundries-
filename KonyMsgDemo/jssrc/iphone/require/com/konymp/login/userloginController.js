    ...
    return {
        ...
        initGettersSetters: function() {
            ...
            defineSetter(this, "usernameMinimumChar", function(val) {
                ...
                try {
                    if (val == null || val == undefined) {
                        kony.logger.warn("Username Min Char is undefined");
                        throw {
                    ...
                    if (isNaN(val)) {
                        kony.logger.warn("Invalid datatype for Username Min Characters Property");
                        throw {
                            "Error": "LoginComponent",
                    ...
                    if (this.usernameMaxChar < val) {
                        kony.logger.warn("usernameMaxChar is less than usernameMinimumChar");
                        throw {
                            "Error": "LoginComponent",
            ...
            defineSetter(this, "passwordMinimumChar", function(val) {
                ...
                try {
                    if (val == null || val == undefined) {
                        kony.logger.warn("Password Min Char is undefined");
                        throw {
                            "Error": "LoginComponent",
                    ...
                    if (isNaN(val)) {
                        kony.logger.warn("Invalid datatype for Password Min Characters Property");
                        throw {
                            "Error": "LoginComponent",
                    ...
                    if (this.passwordMaxChar < val) {
                        kony.logger.warn("passwordMaxChar is less than password Min Character");
                        throw {
                            "Error": "LoginComponent",
        ...
        checkTouchIdSupoort: function() {
            kony.logger.trace("---------------Entering checkTouchIdSupoort function---------------", kony.logger.FUNCTION_ENTRY);
            try {
                var status = kony.localAuthentication.getStatusForAuthenticationMode(constants.LOCAL_AUTHENTICATION_MODE_TOUCH_ID);
            ...
            kony.logger.trace("---------------Exiting checkTouchIdSupoort function---------------", kony.logger.FUNCTION_ENTRY);
        }
    };
});