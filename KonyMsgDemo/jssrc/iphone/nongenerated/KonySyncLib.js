...
//  --Generated On Mon May 29 14:13:58 IST 2017******************* 
//  **************** Start jsonWriter.js*******************
...
kony.sync.checkForUpdate6xto70Schema = function(tx) {
    var sql = "select count (id) from konysyncBLOBSTOREMANAGER";
    var resultSet = kony.sync.executeSql(tx, sql, null, null, false);
    if (resultSet === false) {
        //DDL scripts for 6.x to 7.0 DB Update 
        kony.sync.configVersion = konysyncClientSyncConfig.Version;
        kony.sync.DDL6xto70Update = ["CREATE TABLE \"konysyncBLOBSTOREMANAGER\" (\"id\" integer not null,\"localPath\" text,\"tableName\"text,\"columnName\" text,\"type\" text,\"state\" integer,\"status\" integer,\"size\" integer,\"retry\" integer,\"lastUpdatedTimeStamp\" TIMESTAMP default CURRENT_TIMESTAMP,primary key (\"id\"))"];
    }
